...
class NLPController(BaseController):
    ...
    def index_into_vector_db(self, project: Project, chunks: List[DataChunk],
        ...
        # ← Now you can detect collection creation failure
        collection_result = self.vectordb_client.create_collection(
        ...
        if collection_result is None:
            self.logger.error("Collection creation failed, aborting insert")
            return False
