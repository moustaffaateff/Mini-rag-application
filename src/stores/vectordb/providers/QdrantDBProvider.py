...
class QdrantDBProvider(VectorDBInterface):
    ...
    def insert_one(self, collection_name: str, text: str, vector: list,
        ...
        try:
            _ = self.client.upsert(           # ← upsert instead of upload_collection
                collection_name=collection_name,
                points=[
                    models.PointStruct(       # ← PointStruct instead of Record
                        id=record_id,
                        vector=vector,
    ...
    def insert_many(self, collection_name: str, texts: list, 
        ...
        for i in range(0, len(texts), batch_size):
            ...
            try:
                _ = self.client.upsert(      # ← upsert instead of upload_records
                    collection_name=collection_name,
                    points=batch_points,     # ← points instead of records
                )
            except Exception as e:
