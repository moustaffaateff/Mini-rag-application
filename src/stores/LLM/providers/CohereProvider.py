...
class CohereProvider(LLMInterface):
    ...
    # important to limit the input text such it doesn't exeed the limit of the input text , to prevent any mistakes(uploading many chunks by mistake and use all tokens)
    ...
    def generate_text(self, prompt: str, chat_history: list=[], max_output_tokens: int=None,
        ...
        if not response or not response.text : 
            self.logger.error("Error while generating text in Cohere")
            return None    
